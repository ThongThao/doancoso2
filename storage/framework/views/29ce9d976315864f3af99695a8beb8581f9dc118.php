...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('public/kidolshop/images/favicon.png')); ?>">

    <!-- CSS
	============================================ -->

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/vendor/bootstrap.min.css')); ?>">

    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/vendor/plazaicon.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/vendor/themify-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/vendor/font-awesome.min.css')); ?>">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/plugins/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/plugins/swiper-bundle.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/plugins/select2.min.css')); ?>">

    <!-- Helper CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/helper.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/dataTables.bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/responsive.bootstrap.min.css')); ?>">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/kidolshop/css/style.css')); ?>">
    ...
    <!-- Modernizer JS -->
    <script src="<?php echo e(asset('public/kidolshop/js/vendor/modernizr-3.6.0.min.js')); ?>"></script>
    <!-- jQuery JS -->
    <script src="<?php echo e(asset('public/kidolshop/js/vendor/jquery-3.3.1.min.js')); ?>" integrity="sha384-tsQFqpEReu7ZLhBV2VZlAu7zcOV+rXbYlF2cqB8txI/8aZajjp4Bqd+V6D5IgvKT" 
        crossorigin="anonymous">
    </script>
    <script src="<?php echo e(asset('public/kidolshop/js/jquery.preloadinator.min.js')); ?>"></script>
...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0" class="preloader-deactive">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="header-logo">
                                <a href="<?php echo e(URL::to('/home')); ?>"><img src="<?php echo e(asset('public/kidolshop/images/logo/logo.png')); ?>" alt=""></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="mega-sub-menu">
                                                ...
                                                <li class="mega-dropdown">
                                                    <a class="menu-banner" href="#">
                                                        <img src="<?php echo e(asset('public/kidolshop/images/banner-navbar.jpg')); ?>" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="<?php echo e(URL::to('/blog')); ?>">Tin tức</a></li>
                                        <li><a href="<?php echo e(URL::to('/about-us')); ?>">Về chúng tôi</a></li>
                                ...
                                <div class="header-account">
                                    <div class="header-account-list dropdown top-link">
                                        <?php if(Session::get('idCustomer')): ?>
                                            ...
                                            <a href="#" role="button" data-toggle="dropdown"><img style="border-radius:50%;" width="70px" height="24px" src="<?php echo e(asset('public/storage/kidoldash/images/customer/'.Session::get('AvatarCus'))); ?>" alt=""></a>
                                                    ...
                                                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="single-cart-box">
                                                            <div class="cart-img">
                                                                ...
                                                                <a href="<?php echo e(URL::to('shop-single/'.$cart->ProductSlug)); ?>"><img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" alt=""></a>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <ul class="dropdown-menu" style="height:250px; width:250px;">
                                                <li style="height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center;">
                                                    <img src="<?php echo e(asset('public/kidolshop/images/no_cart.png')); ?>" alt="" style="width: 80%;" class="product-image">
                        ...
                        <div class="header-meta-info">
                            <div class="header-account">
                                <div class="header-account-list dropdown top-link">
                                    <?php if(Session::get('idCustomer')): ?>
                                        <?php if(Session::get('AvatarCus') != ''): ?>
                                        <a href="#" role="button" data-toggle="dropdown" style="top:-3px;"><img style="border-radius:50%;" width="24px" height="24px" src="<?php echo e(asset('public/storage/kidoldash/images/customer/'.Session::get('AvatarCus'))); ?>" alt=""></a>
                                        <?php else: ?> <a href="#" role="button" data-toggle="dropdown"><i class="icon-users"></i></a> <?php endif; ?>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo e(URL::to('/account')); ?>">Tài khoản của tôi</a></li>
                                        <li><a href="<?php echo e(URL::to('/wishlist')); ?>">Sản phẩm yêu thích</a></li>
                    ...
                    <ul class="navbar-mobile-wrapper">
                        ...
                        <li>
                            ...
                            <ul class="mega-sub-menu">
                                ...
                                <!-- <li class="mega-dropdown">
                                    <a class="menu-banner" href="#">
                                        <img src="<?php echo e(asset('public/kidolshop/images/menu-banner.jpg')); ?>" alt="">
                                    </a>
                                </li> -->
                            </ul>
                        </li>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-widget">
                                <a class="footer-logo" href="#"><img src="<?php echo e(asset('public/kidolshop/images/logo/logo.png')); ?>" alt=""></a>
            ...
            <div class="container">
                <div class="copyright-wrapper text-center d-lg-flex align-items-center justify-content-between">
                    ...
                    <div class="copyright-payment">
                        <img src="<?php echo e(asset('public/kidolshop/images/payment.png')); ?>" alt="">
                    </div>
                    <!--Right End-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="quick-view-image">
                                    <img src="<?php echo e(asset('public/kidolshop/images/product-single/product-1.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-body modal-compare-body row">
                        <div class="product-item col-md-3 select-pd" id="product-item-41" data-id="41">
                            <div class="product-image mb-3" id="product-image-41">
                                <label class="abc" for="chk-pd-41"><img src="<?php echo e(asset('public/kidolshop/images/no_cart.png')); ?>" class="rounded w-100 img-fluid"></label>       
    ...
    <!-- Bootstrap JS -->
    <script src="<?php echo e(asset('public/kidolshop/js/vendor/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/vendor/bootstrap.min.js')); ?>"></script>

    <!-- Plugins JS -->
    <script src="<?php echo e(asset('public/kidolshop/js/plugins/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/plugins/jquery.countdown.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/plugins/jquery.elevateZoom.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/plugins/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/plugins/ajax-contact.js')); ?>"></script>
    ...
    <!-- Main JS -->
    <script src="<?php echo e(asset('public/kidolshop/js/main.js')); ?>"></script>


    <!-- Google Map js -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBQ5y0EF8dE6qwc03FcbXHJfXr4vEa7z54"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/map-script.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidoldash/js/form-validate.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/dataTables.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/dataTables.responsive.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/kidolshop/js/responsive.bootstrap.min.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).ready(function(){  
            ...
            $('.add-to-compare').on('click',function(){
                ...
                $.ajax({
                    url: '<?php echo e(url("/modal-compare")); ?>',
                    method: 'POST',
...
</html><?php /**PATH C:\xampp\htdocs\Kidolshop\kidolshop\resources\views/shop_layout.blade.php ENDPATH**/ ?>