                    ...
                    <div class="tab-pane fade show active" id="pills-password">
                        <div class="my-account-address account-wrapper">
                            <div class="row">
                                ...
                                <form method="POST" action="<?php echo e(URL::to('/submit-change-password')); ?>" id="form-changepassword">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/customer/change-password.blade.php ENDPATH**/ ?>