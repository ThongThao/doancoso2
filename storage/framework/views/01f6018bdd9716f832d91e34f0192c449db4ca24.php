                                ...
                                <div class="my-account-address account-wrapper">
                                    <div class="row">
                                        <div class="col-md-12" style="border-bottom: solid 1px #efefef;">
                                            ...
                                            <form method="POST" action="<?php echo e(URL::to('/edit-profile')); ?>" id="form-edit-profile" style="display:flex; padding: 0;" enctype="multipart/form-data">
                                             <?php echo csrf_field(); ?>
                                            <div class="col-md-8 mt-10">
                                                <div class="account-address">
                                                    ...
                                                    <div class="form-group mb-30">
                                                        ...
                                                        <input id="fname" name="CustomerName" class="ml-30" style="width:65%;" type="text" value="<?php echo e($customer->CustomerName); ?>">
                                                        <span class="text-danger"></span>
                                                    </div>
                                                    <div class="form-group mb-30">
                                                        <span  for="nmphone"  class="profile__info-body-left-item-title" style="margin-left: 52px;">Số Điện Thoại</span>
                                                        <input class="ml-30" style="width:65%;" name="PhoneNumber" id="nmphone" type="text" value="<?php echo e($customer->PhoneNumber); ?>">
                                                        <span class="text-danger"></span>
                                                    </div>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/customer/my-account.blade.php ENDPATH**/ ?>