            ...
            <div class="col-lg-6 col-md-8">
                <div class="shop-image">
                    <div class="shop-single-preview-image">
                        <img class="product-zoom" src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" alt="">
                    ...
                    <div id="gallery_01" class="shop-single-thumb-image shop-thumb-active swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide single-product-thumb">
                                <a class="active" href="#" data-image="<?php echo e(asset('public/storage/kidoldash/images/product/'.$img)); ?>">
                                    <img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$img)); ?>" alt="">
                                </a>
                            </div>
                ...
                <div class="shop-single-content">
                    ...
                    <div class="custom-payment-options">
                        ...
                        <ul class="payment-options">
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-1.svg')); ?>" alt=""></li>
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-2.svg')); ?>" alt=""></li>
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-3.svg')); ?>" alt=""></li>
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-4.svg')); ?>" alt=""></li>
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-5.svg')); ?>" alt=""></li>
                            <li><img src="<?php echo e(asset('public/kidolshop/images/payment-icon/payment-7.svg')); ?>" alt=""></li>
                        </ul>
                    </div>
                        ...
                        <div class="single-product">
                            <div class="product-image">
                                ...
                                <a href="<?php echo e(URL::to('/shop-single/'.$related_product->ProductSlug)); ?>">
                                    <img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" alt="">
                                </a>
        ...
        <div class="brand-active swiper-container">
            <div class="swiper-wrapper">
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-1.jpg')); ?>" alt="">
                </div>
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-2.jpg')); ?>" alt="">
                </div>
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-3.jpg')); ?>" alt="">
                </div>
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-4.jpg')); ?>" alt="">
                </div>
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-5.jpg')); ?>" alt="">
                </div>
                <div class="single-brand swiper-slide">
                    <img src="<?php echo e(asset('public/kidolshop/images/brand/brand-6.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/shop/product/shop-single.blade.php ENDPATH**/ ?>