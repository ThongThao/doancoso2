        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <!-- <div class="shop-banner">
                    <a href="#"><img src="<?php echo e(asset('public/kidolshop/images/banner/banner.png')); ?>" alt=""></a>
                </div> -->
                <!--Shop Top Bar Start-->
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/shop/product/shop-all-product.blade.php ENDPATH**/ ?>