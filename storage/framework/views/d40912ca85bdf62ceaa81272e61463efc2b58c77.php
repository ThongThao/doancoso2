            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="product-item">
                        ...
                        <td class="image">
                            <a href="<?php echo e(URL::to('/shop-single/'.$pd_cart->ProductSlug)); ?>"><img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" alt=""></a>
                        </td>
                        <td class="product">
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/shop/cart/payment.blade.php ENDPATH**/ ?>