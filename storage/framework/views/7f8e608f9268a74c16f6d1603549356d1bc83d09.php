                        ...
                        <tbody class="ligth-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img class="rounded img-fluid avatar-50"
                                        src="public/storage/admin/images/user/<?php echo e($staff->Avatar); ?>" alt="profile"></td>
                                <?php else: ?>
                                <td class="text-center"><img class="rounded img-fluid avatar-50"
                                        src="public/admin/images/user/12.jpg" alt="profile"></td>
                                <?php endif; ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/admin/manage-users/manage-staffs.blade.php ENDPATH**/ ?>