            ...
            <div class="modal-body row">
                ...
                <div class="product-item col-md-3 select-pd" id="product-item-<?php echo e($product->idProduct); ?>" data-id="<?php echo e($product->idProduct); ?>">
                    <div class="product-image mb-3" id="product-image-<?php echo e($product->idProduct); ?>">
                        ...
                        <label for="chk-pd-<?php echo e($product->idProduct); ?>"><img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" class="rounded w-100 img-fluid"/></label>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/admin/product/sale/add-sale.blade.php ENDPATH**/ ?>