                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    ...
                                    <div>
                                        ...
                                        <h4><?php echo e(number_format($total_bill,0,',','.')); ?> đơn hàng</h4>
                                    </div>
                                </div>                                
                                <div class="iq-progress-bar mt-2">
                                    <span class="bg-info iq-progress progress-1" data-percent="85">
                                ...
                                <div class="card card-block card-stretch mb-0">
                                    <div class="card-body">
                                        <div class="bg-warning-light rounded">
                                            ...
                                            <img src="<?php echo e(asset('public/storage/admin/images/product/'.$image)); ?>" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                    ...
                    <div class="card-body--AllTime card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="iq-avatar d-flex align-items-center">
                                ...
                                <img src="<?php echo e(asset('public/storage/admin/images/product/'.$image)); ?>" class="p-0 avatar-100 style-img img-fluid m-auto rounded" alt="image">
                            </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>