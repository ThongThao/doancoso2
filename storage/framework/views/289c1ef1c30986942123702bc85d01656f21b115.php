                ...
                <tbody>
                    ...
                    <tr class="product-item">
                        ...
                        <td class="remove">
                                        ...
                                        <a class="badge bg-warning mr-2" data-toggle="modal" data-target="#modal-delete-<?php echo e($pd_cart->idCart); ?>" data-placement="top" title="" data-original-title="Xoá"
                    ...
                    <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" id="modal-delete-<?php echo e($pd_cart->idCart); ?>"  aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?php echo e(URL::to('/delete-pd-cart/'.$pd_cart->idCart)); ?>" type="button" class="btn btn-primary">Xác nhận</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/cart/cart.blade.php ENDPATH**/ ?>