                        ...
                        <tbody class="ligth-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img class="rounded img-fluid avatar-40"
                                        src="public/ericshop/images/customer/<?php echo e($customer->Avatar); ?>" alt="profile"></td>
                                <?php else: ?>
                                <td class="text-center"><img class="rounded img-fluid avatar-40"
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/admin/manage-users/manage-customers.blade.php ENDPATH**/ ?>