...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="<?php echo e(asset('public/kidoldash/images/favicon.ico')); ?>" />
      <link rel="stylesheet" href="<?php echo e(asset('public/kidoldash/css/backend-plugin.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('public/kidoldash/css/backend.css?v=1.0.0')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('public/kidoldash/vendor/@fortawesome/fontawesome-free/css/all.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('public/kidoldash/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('public/kidoldash/vendor/remixicon/fonts/remixicon.css')); ?>">
    </head>
  <body class="  ">
    <!-- loader Start -->
    <div id="loading">
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="<?php echo e(URL::to('/dashboard')); ?>" class="header-logo">
                <img src="<?php echo e(asset('public/kidoldash/images/logo.png')); ?>" class="img-fluid rounded-normal light-logo" alt="logo">
                  <h5 class="logo-title light-logo ml-2">Dashboard</h5>
              </a>
                  ...
                  <div class="card border-none">
                      <div class="card-body p-0">
                          <div class="sidebarbottom-content">
                              <div class="image"><img src="<?php echo e(asset('public/kidoldash/images/layouts/side-bkg.png')); ?>" class="img-fluid" alt="side-bkg"></div>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="iq-navbar-custom">
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="<?php echo e(URL::to('/dashboard')); ?>" class="header-logo">
                          <img src="<?php echo e(asset('public/kidoldash/images/logo.png')); ?>" class="img-fluid rounded-normal" alt="logo">
                          ...
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                              <li class="nav-item nav-icon dropdown">
                                  <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                                      ...
                                      aria-expanded="false">
                                      <img src="<?php echo e(asset('public/kidoldash/images/small/Vietnam-Flag.png')); ?>" alt="img-flag"
                                      ...
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-3">
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('public/kidoldash/images/small/flag-02.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">French</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('public/kidoldash/images/small/flag-03.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">Spanish</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('public/kidoldash/images/small/flag-04.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">Italian</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('public/kidoldash/images/small/flag-05.png')); ?>" alt="img-flag"
                                                      class="img-fluid mr-2">German</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="<?php echo e(asset('public/kidoldash/images/small/flag-06.png')); ?>" alt="img-flag"
                                              ...
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                      ...
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('public/kidoldash/images/user/01.jpg')); ?>" alt="01">
                                                          </div>
                                                  ...
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('public/kidoldash/images/user/02.jpg')); ?>" alt="02">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                                                  ...
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('public/kidoldash/images/user/03.jpg')); ?>" alt="03">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                                              ...
                                              <div class="px-3 pt-0 pb-0 sub-card">
                                                  <a href="#" class="iq-sub-card">
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="">
                                                              <img class="avatar-50 rounded-small"
                                                                  src="<?php echo e(asset('public/kidoldash/images/logo.png')); ?>" alt="01">
                                                          </div>
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                       <?php if($avatar != ''): ?>
                                        <img src="<?php echo e(asset('public/storage/kidoldash/images/user/'.$avatar)); ?>" class="img-fluid rounded" alt="user">
                                       <?php else: ?>
                                        <img src="<?php echo e(asset('public/kidoldash/images/user/12.jpg')); ?>" class="img-fluid rounded" alt="user">
                                       <?php endif; ?>
                                  </a>
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 text-center">
                                              <div class="media-body profile-detail text-center">
                                                  <img src="<?php echo e(asset('public/kidoldash/images/page-img/profile-bg.jpg')); ?>" alt="profile-bg"
                                                      class="rounded-top img-fluid mb-4">
                                                  <?php if($avatar != null): ?>
                                                  <img src="<?php echo e(asset('public/storage/kidoldash/images/user/'.$avatar)); ?>" alt="profile-img"
                                                      class="rounded profile-img img-fluid avatar-70">
                                                  <?php else: ?>
                                                  <img src="<?php echo e(asset('public/kidoldash/images/user/12.jpg')); ?>" alt="profile-img"
                                                      class="rounded profile-img img-fluid avatar-70">
                                                  <?php endif; ?>
                                              </div>
                                              <div class="p-3">
...
<script src="<?php echo e(asset('public/kidoldash/js/backend-bundle.min.js')); ?>"></script>

<!-- Table Treeview JavaScript -->
<script src="<?php echo e(asset('public/kidoldash/js/table-treeview.js')); ?>"></script>

<!-- Chart Custom JavaScript -->
<script src="<?php echo e(asset('public/kidoldash/js/customizer.js')); ?>"></script>

<!-- Chart Custom JavaScript -->
<script async src="<?php echo e(asset('public/kidoldash/js/chart-custom.js')); ?>"></script>

<!-- app JavaScript -->
<script src="<?php echo e(asset('public/kidoldash/js/app.js')); ?>"></script>

<script src="<?php echo e(asset('public/kidoldash/js/ckeditor/ckeditor.js')); ?>"></script>

<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/kidoldash/datetimepicker-master/jquery.datetimepicker.css')); ?>">
<script src="<?php echo e(asset('public/kidoldash/datetimepicker-master/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('public/kidoldash/datetimepicker-master/build/jquery.datetimepicker.full.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/kidoldash/js/moment.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/admin_layout.blade.php ENDPATH**/ ?>