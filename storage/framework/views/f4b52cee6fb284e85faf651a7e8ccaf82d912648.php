...
<div class="empty-cart-page section-padding-5">
    <div class="container">
        <div class="row flex-row-reverse">
            ...
            <h3>Về chúng tôi</h3>
            <h4>Chào mừng bạn đến với <span style="color: brown;"><a href="<?php echo e(URL::to('/home')); ?>">EricShop</a></span>!</h4>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/about/about_us.blade.php ENDPATH**/ ?>