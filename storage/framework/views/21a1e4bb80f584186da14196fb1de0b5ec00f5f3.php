...
<!--Page Banner Start-->
<div class="page-banner" style="background-image: url(public/ericshop/images/spbn.png);">
    <div class="container">
                        ...
                        <table id="example" class="table table-striped table-bordered wishlist-table" style="width:100%;">
                            ...
                            <tbody>             
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(URL::to('/shop-single/'.$wish->ProductSlug)); ?>"><img src="<?php echo e(asset('public/storage/admin/images/product/'.$image)); ?>" alt=""></a>
                                    </td>
                                    <td>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/customer/wishlist.blade.php ENDPATH**/ ?>