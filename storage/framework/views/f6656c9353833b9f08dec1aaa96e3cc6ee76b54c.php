...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('public/ericshop/images/shortlogo.png')); ?>">

    <!-- CSS
	============================================ -->

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/vendor/bootstrap.min.css')); ?>">

    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/vendor/plazaicon.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/vendor/themify-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/vendor/font-awesome.min.css')); ?>">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/plugins/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/plugins/swiper-bundle.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/plugins/select2.min.css')); ?>">

    <!-- Helper CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/helper.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/dataTables.bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/responsive.bootstrap.min.css')); ?>">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/ericshop/css/style.css')); ?>">
    <style>
        @import  url('https://fonts.googleapis.com/css2?family=Kanit:wght@600&display=swap');
    </style>
    <!-- Modernizer JS -->
    <script src="<?php echo e(asset('public/ericshop/js/vendor/modernizr-3.6.0.min.js')); ?>"></script>
    <!-- jQuery JS -->
    <script src="<?php echo e(asset('public/ericshop/js/vendor/jquery-3.3.1.min.js')); ?>"
        integrity="sha384-tsQFqpEReu7ZLhBV2VZlAu7zcOV+rXbYlF2cqB8txI/8aZajjp4Bqd+V6D5IgvKT" crossorigin="anonymous">
        </script>
    <script src="<?php echo e(asset('public/ericshop/js/jquery.preloadinator.min.js')); ?>"></script>
...
<body data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0" class="preloader-deactive">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="header-logo">
                                <a href="<?php echo e(URL::to('/home')); ?>"><img src="<?php echo e(asset('public/ericshop/images/logoo.png')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="site-main-nav">
                                <nav class="site-nav">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo e(URL::to('/store')); ?>">Cửa hàng </a>
                                            ...
                                            <ul class="mega-sub-menu"
                                                ...
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        ...
                                                        <li><a
                                                                href="<?php echo e(URL::to('/store?show=all&category='.$category->idCategory.'&sort_by=new')); ?>"><?php echo e($category->CategoryName); ?></a>
                                                        </li>
                                                ...
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        ...
                                                        <li><a
                                                                href="<?php echo e(URL::to('/store?show=all&brand='.$brand->idBrand.'&sort_by=new')); ?>"><?php echo e($brand->BrandName); ?></a>
                                                        </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </li>
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        <li><a href="<?php echo e(URL::to('/store?show=all&sort_by=new')); ?>">Sản
                                                                phẩm mới</a></li>
                                                        <li><a
                                                                href="<?php echo e(URL::to('/store?show=all&sort_by=bestsellers')); ?>">Sản
                                                                phẩm bán chạy</a></li>
                                                        <li><a href="<?php echo e(URL::to('/store?show=all&sort_by=featured')); ?>">Sản
                                                                phẩm nổi bật</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="<?php echo e(URL::to('/about_us')); ?>">Giới thiệu</a></li>
                                ...
                                <div class="header-account">
                                    <div class="header-account-list dropdown top-link">
                                        ...
                                        <a href="#" role="button" data-toggle="dropdown"><img style="border-radius:50%;"
                                                ...
                                                src="<?php echo e(asset('public/storage/admin/images/customer/'.Session::get('AvatarCus'))); ?>"
                                                alt=""></a>
                                        <?php else: ?> <a href="#" role="button" data-toggle="dropdown"><i
                                                class="icon-users"></i></a> <?php endif; ?>
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo e(URL::to('/account')); ?>">Quản lý tài khoản</a></li>
                                    ...
                                    <div class="header-account-list dropdown mini-cart">
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li class="product-cart">
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        ...
                                                        <a href="<?php echo e(URL::to('shop-single/'.$cart->ProductSlug)); ?>"><img
                                                                src="<?php echo e(asset('public/storage/admin/images/product/'.$image)); ?>"
                                                                alt=""></a>
                                                        <span class="pro-quantity"><?php echo e($cart->QuantityBuy); ?></span>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h6 class="title"><a
                                                                href="<?php echo e(URL::to('shop-single/'.$cart->ProductSlug)); ?>"><?php echo e($cart->ProductName); ?></a>
                                                        </h6>
                                                        <span class="title"
                                                            style="font-size:13px;"><?php echo e($cart->AttributeProduct); ?></span>
                                                        <div class="cart-price d-flex">
                                                            <span class="sale-price"><?php echo e(number_format($cart->Price, 0,
                                                                ',', '.')); ?>đ</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="product-total">
                                                <ul class="cart-total">
                                                    <li> Tổng : <span><?php echo e(number_format($Total, 0, ',', '.')); ?>đ</span>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="product-btn">
                                                <a href="<?php echo e(URL::to('/cart')); ?>" class="btn btn-dark btn-block">Xem giỏ
                                                    hàng</a>
                                            </li>
                                        </ul>
                                        <?php else: ?>
                                        ...
                                        <ul class="dropdown-menu" style="height:250px; width:250px;">
                                            <li
                                                ...
                                                <img src="<?php echo e(asset('public/ericshop/images/no_cart.png')); ?>" alt=""
        ...
        <div class="header-mobile d-lg-none">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-6">
                        <div class="header-logo">
                            <a href="<?php echo e(URL::to('/home')); ?>"><img src="<?php echo e(asset('public/ericshop/images/logo/logo.png')); ?>"
                                    alt=""></a>
                        </div>
                    </div>
                    <div class="col-6">
                                    ...
                                    <ul class="dropdown-menu ">
                                        <li class="product-cart">
                                            ...
                                            <div class="single-cart-box">
                                                ...
                                                <a class="del-icon delete-pd-cart" data-id="<?php echo e($cart->idCart); ?>"
                                                    data-token="<?php echo e(csrf_token()); ?>"><i class="fa fa-trash"></i></a>
                                            </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </li>
                                        <li class="product-total">
                            ...
                            <ul class="mega-sub-menu">
                                ...
                                <li class="mega-dropdown">
                                    ...
                                    <ul class="mega-item">
                                        ...
                                        <li><a href="<?php echo e(URL::to('/store?show=all&sort_by=bestsellers')); ?>">Sản phẩm bán
                                                chạy</a></li>
                                        <li><a href="<?php echo e(URL::to('/store?show=all&sort_by=featured')); ?>">Sản phẩm nổi
                                                bật</a></li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-widget">
                                <a class="footer-logo" href="#"><img
                                        src="<?php echo e(asset('public/ericshop/images/logo/logo.png')); ?>" alt=""></a>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <div class="footer-widget-menu">
                                    <ul>
                                        <li><a href="<?php echo e(URL::to('/account')); ?>">Tài khoản</a></li>
    ...
    <!-- Bootstrap JS -->
    <script src="<?php echo e(asset('public/ericshop/js/vendor/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/vendor/bootstrap.min.js')); ?>"></script>

    <!-- Plugins JS -->
    <script src="<?php echo e(asset('public/ericshop/js/plugins/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/plugins/jquery.countdown.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/plugins/jquery.elevateZoom.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/plugins/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/plugins/ajax-contact.js')); ?>"></script>
    ...
    <!-- Main JS -->
    <script src="<?php echo e(asset('public/ericshop/js/main.js')); ?>"></script>


    <!-- Google Map js -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBQ5y0EF8dE6qwc03FcbXHJfXr4vEa7z54"></script>
    <script src="<?php echo e(asset('public/ericshop/js/map-script.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/form-validate.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/dataTables.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/dataTables.responsive.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/ericshop/js/responsive.bootstrap.min.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop_layout.blade.php ENDPATH**/ ?>