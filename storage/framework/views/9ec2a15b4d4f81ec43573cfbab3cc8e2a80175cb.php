                                ...
                                <div class="card card-block card-stretch mb-0">
                                    <div class="card-body">
                                        <div class="bg-warning-light rounded">
                                            ...
                                            <img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                    ...
                    <div class="card-body--AllTime card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="iq-avatar d-flex align-items-center">
                                ...
                                <img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" class="p-0 avatar-100 style-img img-fluid m-auto rounded" alt="image">
                            </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>