                                ...
                                <div class="single-product">
                                    <div class="product-image">
                                        ...
                                        <div class="action-links">
                                            <ul>
                                                <li><a class="add-to-wishlist" data-id="<?php echo e($pd->idProduct); ?>"
                                                        data-tooltip="tooltip" data-placement="left"
                                                        title="Thêm vào danh sách yêu thích"><i
                                                            class="icon-heart"></i></a></li>
                                                <li><a class="quick-view-pd" data-id="<?php echo e($pd->idProduct); ?>"
                                                        data-tooltip="tooltip" data-placement="left"
                                    ...
                                    <div class="product-content text-center">
                                        <h4 class="product-name"><a
                                                href="<?php echo e(URL::to('/shop-single/'.$pd->ProductSlug)); ?>"><?php echo e($pd->ProductName); ?></a>
                                        </h4>
                                        <div class="price-box">
                    ...
                    <div class="tab-pane fade" id="list" role="tabpanel">
                        ...
                        <div class="single-product product-list">
                            <div class="product-image">
                                ...
                                <div class="action-links">
                                    <ul>
                                        <li><a class="quick-view-pd" data-id="<?php echo e($pd->idProduct); ?>" data-tooltip="tooltip"
                            ...
                            <div class="product-content">
                                ...
                                <ul class="action-links">
                                    <li><a class="add-to-wishlist" data-id="<?php echo e($pd->idProduct); ?>" data-tooltip="tooltip"
                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="categories-list">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                ?>
                                class="filter-product" type="checkbox" id="cat-<?php echo e($category->idCategory); ?>"
                                data-filter="category" value="<?php echo e($category->idCategory); ?>" name="category-filter"
                                style="width:15px;height:15px;">
                                <label class="mb-0 ml-2" for="cat-<?php echo e($category->idCategory); ?>"
                                    style="font-size:15px;cursor:pointer;"><span
                                        style="position:relative; top:2px;"><?php echo e($category->CategoryName); ?></span></label>
                                <span
                                    style="margin-left:auto">(<?php echo e(App\Models\Product::where('idCategory',$category->idCategory)->where('StatusPro','1')->count()); ?>)</span>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-categories">
                        ...
                        <ul class="categories-list">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                ?>
                                class="filter-product" type="checkbox" id="brand-<?php echo e($brand->idBrand); ?>"
                                data-filter="brand" value="<?php echo e($brand->idBrand); ?>" name="brand-filter"
                                style="width:15px;height:15px;">
                                <label class="mb-0 ml-2" for="brand-<?php echo e($brand->idBrand); ?>"
                                    style="font-size:15px;cursor:pointer;"><span
                                        style="position:relative; top:2px;"><?php echo e($brand->BrandName); ?></span></label>
                                <span
                                    style="margin-left:auto">(<?php echo e(App\Models\Product::where('idBrand',$brand->idBrand)->where('StatusPro','1')->count()); ?>)</span>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                                ...
                                <div class="single-mini-product">
                                    ...
                                    <div class="product-content">
                                        <h4 class="title"><a class="two-line"
                                                href="<?php echo e(URL::to('/shop-single/'.$top_pd->ProductSlug)); ?>"><?php echo e($top_pd->ProductName); ?></a>
                                        </h4>
                                        <span class="text-primary h6">Đã bán: <?php echo e($top_pd->Sold); ?></span>
                                        <div class="price-box">
                                            <span
                                                class="current-price"><?php echo e(number_format($top_pd->Price,0,',','.')); ?>đ</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ericshop\resources\views/shop/product/shop-all-product.blade.php ENDPATH**/ ?>