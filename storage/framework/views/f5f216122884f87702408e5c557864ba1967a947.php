            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="product-item">
                        ...
                        <td class="image">
                            <a href="<?php echo e(URL::to('/shop-single/'.$bill_info->ProductSlug)); ?>"><img src="<?php echo e(asset('public/storage/kidoldash/images/product/'.$image)); ?>" alt=""></a>
                        </td>
                        <td class="product">
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoopp\kidolshop\resources\views/shop/customer/ordered-info.blade.php ENDPATH**/ ?>